  ...
  return (
    <div className="min-h-screen bg-slate-900 text-slate-200 selection:bg-sky-500/30">
      ...
      <header className="bg-slate-900/80 backdrop-blur-lg border-b border-slate-800 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-sky-500 to-purple-600 flex items-center justify-center shadow-lg shadow-purple-500/20">
              <span className="font-bold text-white text-lg">Q</span>
            </div>
            <h1 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-sky-400 to-purple-400">
              Quantum Drum
            </h1>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col items-center">
            <div className="relative w-full aspect-square max-w-[600px] mx-auto">
              ...
              {/* Legend */}
              <div className="absolute -bottom-12 left-0 right-0 flex justify-center gap-8 text-xs font-mono text-slate-400">
      ...
      <footer className="mt-12 py-8 border-t border-slate-800 text-center text-slate-500 text-sm">
        <p>
          Switch between Classical Membrane mechanics and Quantum Orbital mechanics.
        </p>
      </footer>
    </div>
  );
